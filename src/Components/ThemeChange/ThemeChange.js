...
import ParticlesComponent from '../particles'; // Ensure this path is correct
...
const ThemeChange = () => {
  ...
  const handleThemeChange = () => {
    setChecked(!checked);
    const newColor = checked ? 'green' : '#182E4C'; // Toggle between colors
  ...
  return (
    <div >
      ...
      <ParticlesComponent color={backgroundColor} id="tspp" />
    </div>
  );
};
